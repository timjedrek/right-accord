const data = {
  "metaData": {
    "title": "Home Health Care Solana, FL | RIGHT ACCORD Private Duty Home Health Care",
  ...
  "description": "RIGHT ACCORD Home Health Care proudly serves Solana with compassionate, in-home care services. Whether your loved one needs hourly support or 24-hour specialized care, we tailor every plan to their unique needs.",
  "nearbyLocations": [
  ...
  "headLines": [
    "In-Home Senior Care in Solana, FL",
  ...
  "keywords": [
    "Solana home health care",
    "in-home senior care Solana",
    "dementia care Solana FL",
    "private duty caregivers Solana",
    "elderly care Solana Florida",
    "companion care Solana",

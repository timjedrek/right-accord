...
export default defineConfig({
  ...
  integrations: [
    ...
    sitemap({
      customPages: [
        'https://rightaccordhealth.com/services/hourly-care',
        'https://rightaccordhealth.com/services/home-care-packages',
        'https://rightaccordhealth.com/services/live-in-care',
        'https://rightaccordhealth.com/services/long-term-care-insurance',
        'https://rightaccordhealth.com/services/senior-care-advisors',
        'https://rightaccordhealth.com/services/veteran-aid-attendant-benefits',
        'https://rightaccordhealth.com/specialty-care/alzheimers-dementia-care',
        'https://rightaccordhealth.com/specialty-care/after-stroke-in-home-care',
        'https://rightaccordhealth.com/specialty-care/hospice-end-of-life-care',
        'https://rightaccordhealth.com/specialty-care/parkinsons-disease-care',
        'https://rightaccordhealth.com/specialty-care/post-surgical-recovery-and-rehabilitation-care',
      ],
      filter: (page) => {
        // Exclude admin pages, test pages, and development files
        return (
          !page.includes('/admin/') &&
          !page.includes('/test/') &&
          !page.includes('/dev/') &&
          !page.includes('/_') &&
          !page.includes('/404') &&
          page !== 'https://rightaccordhealth.com/sitemap/' &&
          page !== 'https://rightaccordhealth.com/rss.xml/'
        );
      },
      changefreq: 'weekly',
      priority: 0.7,
      ...
      serialize: (item) => {
        ...
        if (item.url.includes('/blog/')) {
          ...
          item.priority = 0.6;
        } else if (item.url.includes('/services/') || item.url.includes('/specialty-care/')) {
          item.changefreq = 'weekly';
          item.priority = 0.9;
        } else if (
          item.url === 'https://rightaccordhealth.com/' ||
          item.url === 'https://rightaccordhealth.com/about-us/about-right-accord' ||
          item.url === 'https://rightaccordhealth.com/contact'
        ) {
          item.changefreq = 'weekly';
          item.priority = 1.0;
        } else if (item.url.includes('/about-us/') || item.url.includes('/family-services/')) {
          item.changefreq = 'monthly';
          item.priority = 0.8;
        }
        return item;
